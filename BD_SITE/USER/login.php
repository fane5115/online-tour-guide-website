...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err)) {
        $sql = "SELECT id, username, password, rol FROM users WHERE username = ?";
        ...
        if ($stmt = $mysqli->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                ...
                if ($stmt->num_rows == 1) {
                    ...
                    $username_err = "Nu exista niciun cont cu acest nume.";
                }
            } else {
...
<body>
    ...
    <div class="wrapper fadeInDown ">
        <div id="formContent">
            ...
            <!-- Remind Passowrd -->
            <div id="formFooter">
               Nu ai cont? <a class="underlineHover" href="register.php">Inregistreaza-te acum</a>
            </div>
